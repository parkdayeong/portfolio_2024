    ...
    <StyledHome>
      ...
      <div className='right'>
        <div className='tit-wrap'>
          ...
          <Heading level='2'>MY NAME IS DAYEONG PARK</Heading>
          <Heading>
            I'M A
          ...
          <p>
            ...
            웹에이전시 및 프렌차이즈 경력이 있으며, 디자인 및 프론트 개발이 가능합니다.
          </p>
        </div>
        <section>
          ...
          <ul>
            ...
            <li>
              <span>Age : </span>1989.07
            </li>
            <li>
              <span>Phone : </span>010.4515.0718
            </li>
            <li>
              <span>Address : </span>경기도 안양시
            </li>
            <li>
              <span>Email : </span>molra0000@naver.com
            </li>
            {/* <li>
